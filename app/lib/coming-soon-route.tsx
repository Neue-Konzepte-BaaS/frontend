 ...
 * Care guide, Farm settings, Inbox, Me — Board was one of these until issue
 * #39) and issue #25's (Farms, Accounts, Rentals, which wait on admin
 * endpoints the backend doesn't have yet) — everywhere the nav exists but
 * the feature behind it doesn't. Keeps each of those remaining route files
 * down to the one line that actually differs between them: which
 * translation keys to read.
 */
