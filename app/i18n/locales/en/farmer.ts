export const farmer = {
  ...
  settingsMetaTitle: "My farm · BaaS",
  settingsTitle: "My farm",
  ...
  farmAddressLabel: "Address",
  farmDescriptionLabel: "Description",
  farmDescriptionPlaceholder: "What makes your farm special? Crops, history, anything worth knowing …",
  farmFoundedAtLabel: "Founded on",
  farmSave: "Save",
  farmSaving: "Saving…",
  farmSaved: "Your farm details have been saved.",
  farmPublicPageLink: "View public farm page",
  farmTotalArea: "{{area}} m² of plots on the platform",
  farm_nameRequired: "Please enter a name for the farm.",
  farm_addressRequired: "Please enter an address.",
  farm_foundedInFuture: "The founding date cannot be in the future.",
} as const;
