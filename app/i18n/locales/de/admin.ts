...
export const admin: Shape = {
  ...
  careGuideHeading: "Wöchentlicher Pflegeplan",
  careGuideBody: "Anweisungen, die Mietende Woche für Woche auf ihrer Parzelle sehen. Woche 1 ist die erste Woche ihrer eigenen Miete, keine Kalenderwoche.",
  careGuideNoCrops: "Lege zuerst eine Kultur an — ein Pflegeplan gehört immer zu einer.",
  ...
  careTitlePlaceholder: "Sämlinge vereinzeln",
  careBodyLabel: "Was zu tun ist",
  careBodyPlaceholder: "Alle 10 cm die kräftigste Pflanze stehen lassen.",
  careAdd: "Anweisung hinzufügen",
  careSaveEdit: "Änderungen speichern",
  careCancelEdit: "Abbrechen",
  careSaving: "Wird gespeichert…",
  careEdit: "Bearbeiten",
  careInstructionAdded: "Anweisung hinzugefügt.",
  careInstructionUpdated: "Anweisung aktualisiert.",
  careInstructionDeleted: "Anweisung entfernt.",
};
